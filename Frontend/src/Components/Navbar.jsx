...
export default function Navbar() {
    ...
    return (
        <>
            ...
            <div className={`navbar  max-w-screen-2xl container mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 bg-base-100 z-50  dark:bg-slate-900 dark:text-white ${
                sticky?"sticky-navbar shadow-md  duration-300 transition-all ease-in-out bg-base-200 dark:bg-slate-900 dark:text-white":""
            }`}>
                <div className="navbar-start ">
                    ...
                    <a className="cursor-pointer text-2xl">BookFair</a>
                </div>
